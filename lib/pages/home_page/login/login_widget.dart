          ...
          children: [
            Container(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    colors: [Color(0x00FFFFFF), Color(0xFFF4F4F4)],
                    stops: [0.0, 1.0],
                      ...
                      child: Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            ...
                            FFAppState().User = currentUserEmail;
                            setState(() {});
                            ...
                            children: [
                              ...
                              TextSpan(
                                ...
                                recognizer: TapGestureRecognizer()
                                  ..onTap = () async {
                                    logFirebaseEvent(
                                        'LOGIN_PAGE_RichTextSpan_obfa2ju0_ON_TAP');
                                    logFirebaseEvent(
                            ...
                            children: [
                              ...
                              TextSpan(
                                ...
                                recognizer: TapGestureRecognizer()
                                  ..onTap = () async {
                                    logFirebaseEvent(
                                        'LOGIN_PAGE_RichTextSpan_hhobptsi_ON_TAP');
                                    logFirebaseEvent(
                                        'RichTextSpan_navigate_to');

                                    context.pushNamed('Registrasi');
                                  },
                              )
                            ],
                            style: FlutterFlowTheme.of(context)
